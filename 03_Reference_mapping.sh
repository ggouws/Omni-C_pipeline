...
bwa mem -5 -P -S -T0 -t20 reference/30044_10.asm.bp.p_ctg.fasta \
raw_data/Oceanic-Cricket-OmniC-S1_L001_R1_001.fastq.gz raw_data/Oceanic-Cricket-OmniC-S1_L001_R2_001.fastq.gz \
